package com.example.qy.xiaoshipin.login;
...
import com.example.qy.xiaoshipin.common.utils.TCUtils;
...
//                        mUserId = serviceSig.optString("userID");
    ...
    private void loadUserInfo() {
        ...
        mUserId = settings.getString(TCConstants.USER_ID, "");
        mUserPwd = settings.getString(TCConstants.USER_PWD, "");
    }
    ...
    private void saveUserInfo() {
        ...
        editor.putString(TCConstants.USER_ID, mUserId);
        editor.putString(TCConstants.USER_PWD, mUserPwd);
        editor.commit();
    }
    ...
    private void clearUserInfo() {
        ...
        SharedPreferences settings = mContext.getSharedPreferences("TCUserInfo", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        editor.putString(TCConstants.USER_ID, "");
        editor.putString(TCConstants.USER_PWD, "");
        editor.commit();
    }
}
