...
public class TCBubbleViewHelper {
    ...
    public TCBubbleViewHelper() {

    }


    public void setBubbleTextParams(TCBubbleViewParams params) {
        mParams = params;
    ...
    private float getFontHeight() {
        ...
        //Log.i(TAG, "getFontHeight: top =  " + metrics.top + " bottom = " + metrics.bottom + " asc = " + metrics.ascent + " desc = " + metrics.descent + " leding = " + metrics.leading);
