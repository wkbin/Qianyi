package com.example.qy.xiaoshipin.common.widget.beautysetting.utils;
...
//                    mListener.onDownloadFail(TCApplication.getApplication().getString(R.string.video_material_download_progress_material_unzip_failed));
                    stop();
                    return;
                }
                file.delete();
...
//                mListener.onDownloadFail(TCApplication.getApplication().getString(R.string.video_material_download_progress_download_failed));
                stop();
            }
...
//            mListener.onDownloadFail(TCApplication.getApplication().getString(R.string.video_material_download_progress_no_enough_storage_space));
            stop();
            return;
        }
