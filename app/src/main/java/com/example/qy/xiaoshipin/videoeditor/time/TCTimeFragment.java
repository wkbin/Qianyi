...
import com.example.qy.xiaoshipin.common.widget.VideoWorkProgressFragment;
...
import com.example.qy.xiaoshipin.videoeditor.common.widget.videotimeline.SliderViewContainer;
...
public class TCTimeFragment extends BaseEditFragment implements View.OnClickListener {
    ...
    private void initWorkLoadingProgress() {
        if (mWorkLoadingProgress == null) {
            mWorkLoadingProgress = VideoWorkProgressFragment.newInstance(getResources().getString(R.string.tc_time_fragment_video_preprocessing));
    ...
    private void initViews(View view) {
        ...
        Glide.with(this).load(R.drawable.motion_time_normal).into(mTvCancel);
        Glide.with(this).load(R.drawable.motion_time_slow).into(mTvSpeed);
        Glide.with(this).load(R.drawable.motion_time_repeat).into(mTvRepeat);
        Glide.with(this).load(R.drawable.motion_time_reverse).into(mTvReverse);
    }
