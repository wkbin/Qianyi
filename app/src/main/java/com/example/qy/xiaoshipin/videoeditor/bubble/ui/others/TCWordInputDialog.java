package com.example.qy.xiaoshipin.videoeditor.bubble.ui.others;
...
import com.example.qy.xiaoshipin.videoeditor.bubble.utils.ScreenUtils;
...
public class TCWordInputDialog extends DialogFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.word_tv_cancel:
                onClickCancel();
                break;
            case R.id.word_tv_done:
                String text = mEtContent.getText().toString();
                if (TextUtils.isEmpty(text)) {
                    Toast.makeText(v.getContext(),
                            getResources().getString(R.string.tc_word_input_dialog_please_enter_subtitles),
