package com.example.qy.xiaoshipin.videoeditor.bubble;
...
import com.example.qy.xiaoshipin.videoeditor.bubble.ui.bubble.TCBubbleViewParams;
import com.example.qy.xiaoshipin.videoeditor.bubble.ui.bubble.TCWordBubbleView;
import com.example.qy.xiaoshipin.videoeditor.bubble.ui.bubble.TCWordBubbleViewFactory;
import com.example.qy.xiaoshipin.videoeditor.bubble.ui.others.TCWordInputDialog;
import com.example.qy.xiaoshipin.videoeditor.bubble.ui.popwin.TCBubbleSettingView;
import com.example.qy.xiaoshipin.videoeditor.bubble.ui.popwin.TCWordParamsInfo;
import com.example.qy.xiaoshipin.videoeditor.bubble.utils.TCBubbleManager;
import com.example.qy.xiaoshipin.videoeditor.common.widget.BaseRecyclerAdapter;
import com.example.qy.xiaoshipin.videoeditor.common.widget.layer.TCLayerOperationView;
import com.example.qy.xiaoshipin.videoeditor.common.widget.layer.TCLayerViewGroup;
import com.example.qy.xiaoshipin.videoeditor.common.widget.videotimeline.RangeSliderViewContainer;
import com.example.qy.xiaoshipin.videoeditor.common.widget.videotimeline.ViewConst;
...
public class TCBubbleFragment extends BaseEditFragment implements BaseRecyclerAdapter.OnItemClickListener,
    ...
    private void initData() {
        ...
        mDuration = TCVideoEditerWrapper.getInstance().getCutterEndTime() - TCVideoEditerWrapper.getInstance().getCutterStartTime();
        updateDefaultTime();
    }
